    ...
    <div className="about-page">
      ...
      <section className="about-hero">
        ...
        <p className="section-description">
          My audio obsession isn't just a career—it's who I am. Every wedding, every event, every moment matters enough to get it right.
        </p>
      </section>
      ...
      <section className="origin-story">
        <div className="origin-grid">
          <div className="origin-content">
            ...
            <p>
              I'll never forget attending a wedding where the DJ had all the right gear but completely lacked the technique to use it. The audio was echoey, distant, and plagued by feedback. Guests would tilt their heads toward the speakers, confused. The emotional moments were muddy. The dance floor felt flat.
            </p>
            <p>
              Walking out of that reception, something clicked: great equipment means nothing without mastery. I realized then that my technical obsession—my endless tinkering, my ear for audio, my refusal to settle for "good enough"—was exactly what weddings needed.
            </p>

            <div className="story-highlight">
              <p className="highlight-quote">
                "Perfect sound isn't about expensive gear. It's about knowing exactly how to use it."
              </p>
            </div>
      ...
      <section className="journey-section">
        ...
        <div className="timeline-grid">
          <div className="timeline-card">
            ...
            <p>Started playing saxophone and fell in love with music production using FL Studio in 3rd grade.</p>
          </div>

          <div className="timeline-card">
            <h3>St. Olaf College</h3>
            <p>Earned a BA in Music in 2018, deepening my technical and creative foundation.</p>
          </div>

          <div className="timeline-card">
            <h3>Shanghai</h3>
            <p>DJed club nights internationally, learning to read rooms and adapt to any crowd.</p>
          </div>
          ...
          <div className="timeline-card">
            <h3>Today</h3>
            <p>9+ years of DJ experience, countless happy couples, and an unrelenting commitment to perfect sound.</p>
          </div>
        </div>
      </section>
      ...
      <section className="values-section">
        ...
        <div className="values-grid">
          <div className="value-card">
            ...
            <p>Crystal clear ceremony audio, dynamic reception entertainment, and flawless technical execution. No compromise.</p>
          </div>

          <div className="value-card">
            <i data-lucide="eye-off"></i>
            <h3>Invisible Professionalism</h3>
            <p>I'm the expert you'll barely notice—until you do, because everything sounds incredible and runs smoothly.</p>
          </div>

          <div className="value-card">
            <i data-lucide="handshake"></i>
            <h3>Partnership & Ease</h3>
            <p>Your stress is my priority. Quick responses, clear communication, and handling every audio detail so you don't have to.</p>
          </div>

          <div className="value-card">
            <i data-lucide="music"></i>
            <h3>Fun & Energy</h3>
            <p>I genuinely love getting people on the dance floor and creating moments that last a lifetime.</p>
          </div>

          <div className="value-card">
            <i data-lucide="shield-check"></i>
            <h3>Integrity</h3>
            <p>What you see is what you get. No surprises, no hidden fees, no cutting corners. Ever.</p>
          </div>
        </div>
      </section>
      ...
      <section className="about-cta">
        ...
        <p style={{ color: '#F8F6F1', marginBottom: '2rem', fontSize: '1.1rem' }}>
          Let's talk about your wedding and what perfect sound means for your day.
        </p>
