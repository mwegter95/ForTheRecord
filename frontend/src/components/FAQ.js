...
const FAQ = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Yes. We offer dance floor lighting and ambient uplighting options to create the perfect atmosphere for your celebration. These add-ons enhance the energy and visual experience of your reception. We can discuss lighting options when we talk about your complete package and vision for your day."
    },
    {
      ...
      <section className="faq-hero">
        <div className="container">
          ...
          <p className="section-description">
            Everything you need to know about booking your wedding DJ. Can't find your answer?
