...
const Gallery = () => {
  ...
  const galleryItems = [
    { id: 1, image: weddingDanceFloor, category: 'Dance Floor', alt: 'Couple dancing on wedding dance floor' },
    { id: 2, image: weddingDanceFloor2, category: 'Dance Floor', alt: 'Wedding dance floor with energy and movement' },
    { id: 3, image: weddingDanceFloor3, category: 'Dance Floor', alt: 'Wedding guests dancing' },
    { id: 4, image: weddingDanceFloor4, category: 'Dance Floor', alt: 'Dance floor celebration' },
    { id: 5, image: weddingDanceBouquetToss, category: 'Dance Floor', alt: 'Wedding bouquet toss moment' },
    { id: 6, image: weddingCeremonyAudio, category: 'Ceremony', alt: 'Wedding ceremony setup' },
    { id: 7, image: weddingCeremonyAudio2, category: 'Ceremony', alt: 'Ceremony audio equipment' },
    { id: 8, image: wedding1, category: 'Ceremony', alt: 'Wedding ceremony moment' },
    ...
    { id: 12, image: djDecks, category: 'Dance Floor', alt: 'DJ equipment and turntables' },
  ];
      ...
      <section className="gallery-hero">
        <div className="container">
          ...
          <p className="section-description">
            Every wedding tells a unique story. From intimate ceremonies to dance floor celebrations,
            here's a glimpse into the moments we've helped create.
          </p>
        </div>
      </section>
